const footNotes = [
  {
    ...
    "caption": "[1] Our name comes from a passage that a friend of ours found scrawled in the lecture notes of the late ecologist Peter Warshall, after he died. A list of loosely connected thoughts: <br /><br /><span class='footnote-italic'>backyard biodiversity<br />start anywhere<br />learn about power<br />THC insect repellent<br />animal soul<br />FIND NONHUMAN TEACHERS!</span><br /><br />Image credit: Peter Warshall",
    "type": "image",
  },
  {
    "page": "about",
    "number": 2,
    "caption": "[2] We believe that connecting with the natural world should be a social endeavor.<br /><br />Our multidisciplinary events offer artful ways of engaging with and learning about the natural world while also fostering a deep sense of community.<br /><br />Image credit: Nonhuman Teachers",
    "type": "image",
  ...
  },
  {
    ...
    "type": "image",
    "caption": `[1] The use of psychedelic mushrooms by humans traces back thousands of years, with evidence suggesting their ceremonial and religious use in ancient societies.<br /><br />Mesoamerican cultures, such as the Aztecs and Maya, are well-documented for their use of psilocybin mushrooms in spiritual and divinatory rituals, calling them "teonanácatl" or "flesh of the gods."<br /><br />In other regions of the world, cave paintings and historical texts hint at the use of psychoactive fungi in various indigenous cultures.<br /><br />This ancient relationship with psychedelic mushrooms highlights a long-standing human curiosity and connection with altered states of consciousness, and these practices have continued to evolve and influence modern psychiatric, therapeutic, and psychonautical explorations.<br /><br />Image credit: Bugwood Forestry Images`
  },
  {
    "page": "experience-report",
    "number": 2,
    ...
    "type": "image",
    "caption": `[2] Julia Butterfly Hill is an environmental activist who became a symbol of environmental conservation through the extraordinary act of living in a California Redwood <span class="footnote-italic">(Sequoia sempervirens)</span> from December 1997 to December 1999 to prevent it from being cut down by loggers.<br /><br />In a 2021 interview, Ms. Hill said of her time spent in the tree, affectionately named "Luna":<br /><br />"While I was in Luna, I learned that every issue we're facing is the symptom, and the disease is the disease of disconnect."<br /><br />"When we're disconnected from the Earth and we're disconnecting from each other, we make choices and don't realize how it's truly impacting all of us, and that means all the beings, everything, and the future generations."<br /><br />Image credit: Shaun Walker`
  },
  {
    "page": "experience-report",
    "number": 3,
    ...
    "type": "image",
    "caption": `[3] The Sonoran Desert toad <span class="footnote-italic">(Bufo alvarius)</span>, secretes a venom that contains 5-MeO-DMT, a powerful psychedelic compound.<br /><br />In some modern spiritual practices, especially in certain shamanic traditions in Central and North America, this venom is used for its psychoactive effects.<br /><br />Participants in these rituals often describe deeply introspective, life-altering spiritual experiences.<br /><br />Image credit: John D. Willson`
  },
  {
    "page": "experience-report",
    "number": 4,
    ...
    "type": "image",
    "caption": `[4] While scientific support for the healing properties of crystals is limited, their historical and cultural significance is undeniable.<br /><br />Rhodonite is one such mineral, a striking pink and black gemstone that occurs at the famous Manganese-rich mineral locality of Franklin, New Jersey, and in association with Paleozoic chert sequences in British Columbia, Japan, Austria, Spain and North Carolina.<br /><br />In crystal form it is often used in rituals and healing practices in various spiritual and New Age traditions. It is believed to foster emotional healing, balance, and compassion and is often utilized in meditation and energy work as a tool for enhancing emotional understanding and promoting a sense of peace and forgiveness.<br /><br />Voted <span class="footnote-italic">Rock of the Month #22</span> in April, 2003 by <a href="https://turnstone.ca/turnmap.htm" target="_blank">Turnstone Geological Services</a>!<br /><br />Image credit: Graham Wilson`
  },
  {
    "page": "experience-report",
    "number": 5,
    ...
    "type": "image",
    "caption": `[5] Viral infections are often accompanied by elevated body temperatures, commonly referred to as fevers.<br /><br />Fevers can disrupt the sleep cycle, leading to more frequent periods of REM sleep and increased brain activity, leading to more intense neural processes and the vivid and often strange nature of dreams while battling an infection.<br /><br />Image credit: National Institute of Allergy and Infectious Diseases`
  },
  {
    "page": "experience-report",
    "number": 6,
  ...
  },
  {
    "page": "experience-report",
    "number": 9,
    "content": "[9] Serotonin 5-HT2A receptors (5-HT2ARs) are widely distributed in the central nervous system, especially in brain regions essential for learning and cognition.<br /><br/>In addition to endogenous 5-HT, several hallucinogens, antipsychotics, and antidepressants function by targeting 5-HT2ARs.<br /><br />Image credit: David A. Martin & Charles D. Nichols",
    "type": "text",
    "caption": ""
  },
  {
