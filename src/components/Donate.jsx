    ...
    <div className="section" id="donate">
      <div className="section-left">
        ...
        <ul>
          ...
          <li><a href="https://johnmayer.com/">John Mayer Solo</a><span className="footnote-number">17</span></li>
          <li><a href="https://www.madremezcal.com/">Madre Mezcal</a><span className="footnote-number">18</span></li>
          <li><a href="https://www.nyfa.org/">New York Foundation for the Arts</a><span className="footnote-number">19</span></li>
          <li><a href="https://www.nineorchard.com/">Nine Orchard</a><span className="footnote-number">20</span></li>
        </ul>
      </div>
